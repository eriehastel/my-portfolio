...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_fk1701q", // Replace with your EmailJS Service ID
        "template_cutflbw", // Replace with your EmailJS Template ID
        {
          from_name: formData.name,
          from_email: formData.email,
          message: formData.message,
        },
        "eR3O-kbgmZ7JJHILO" // Replace with your EmailJS Public Key
      )
      .then(
        () => {
    ...
    <div id="container" className="container mx-auto">
              ...
              <div id="profile" className="profile-container min-h-screen flex flex-col items-center bg-gradient-to-r from-blue-200/80 to-purple-200/80 py-16 px-8 md:px-24 lg:px-48">
                    ...
                    width: "72%",
                                  ...
                                  <div className="statistic-box flex flex-col items-center text-gray-900 text-center p-4">
                                    <FaBriefcase className="text-4xl text-blue-600 mb-2" />
               ...
               {/* About Section */}
              <div className="about-section bg-white py-16 px-8 md:px-24 lg:px-48 relative">
                  <div className="about-me-section bg-gray-100 shadow-md rounded-xl p-10 flex flex-col md:flex-row items-center justify-between mt-12 w-full max-w-5xl relative">
                    ...
                    style={{borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray"}}>
              ...
              <div className="expertise-section bg-gradient-to-r from-blue-200/80 to-purple-200/80 py-16 px-6 md:px-16 lg:px-32 relative">
                ...
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6 bg-white px-6 py-3 rounded-lg shadow-md w-fit"
                  style={{ borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray" }}>
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 text-center">
                    My Expertise Area
                  </h2>
                </div>
              ...
              {/* Awesome Journey */}
              <div className="journey-section bg-white py-16 px-6 md:px-16 lg:px-32 relative mt-16">
                {/* Title */}
                <div
                  className="absolute top-14 left-1/2 transform -translate-x-1/2 -translate-y-6 bg-gray-100 px-6 py-3 rounded-lg shadow-lg w-fit flex items-center space-x-2"
                  style={{ borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray" }}
                >
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 text-center">
                    🚀 My Journey
                ...
                {/* Common Box for Education & Experience */}
                <div className="max-w-5xl mx-auto bg-gray-50 shadow-lg rounded-xl p-8 md:p-12 hover:shadow-xl transition-shadow duration-300">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300">
                      <h3 className="text-2xl font-semibold text-blue-700 flex items-center mb-4">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          <li key={index} className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded-md shadow-sm">
                            <strong>{edu.title}</strong> - <span className="text-gray-600">{edu.place} {edu.year}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300">
                      <h3 className="text-2xl font-semibold text-green-700 flex items-center mb-4">
                        <FaLaptopCode className="mr-2 text-green-500" /> Experience
                      </h3>
                      <ul className="space-y-4">
                        {[
                          ...
                          <li key={index} className="p-4 border-l-4 border-green-500 bg-green-50 rounded-md shadow-sm">
                            <strong>{exp.title}</strong> - <span className="text-gray-600">{exp.company} {exp.status}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
              ...
              {/* What I Offer */}
              <section className="py-16 bg-gradient-to-r from-blue-200/80 to-purple-200/80 relative">
                  <div className="max-w-6xl mx-auto text-center px-4">
                    {/* Section Title */}
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6 bg-white px-6 py-3 rounded-lg shadow-md w-fit"
                      style={{ borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray" }}>
                      <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-blue-700 text-center tracking-wide">
                        My Expertise Area
                      </h2>
                    </div>

                    {/* Subtitle */}
                    <p className="text-black text-lg mt-16 text-center px-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-16 max-w-5xl mx-auto px-4">
                    {[
                      ...
                      <div key={index} className="bg-white p-5 shadow-md border border-gray-200 rounded-lg text-center hover:shadow-xl transition w-full sm:w-60 mx-auto">
                        ...
                        <h3 className="text-lg font-semibold text-blue-700 mt-2">{service.title}</h3>
              ...
              <section className="projects-section bg-gray-100 py-16 px-6 md:px-16 lg:px-32 shadow-lg rounded-lg relative mt-16">
                      <div className="max-w-6xl mx-auto text-center relative">
                        <div className="absolute top-[-9.5rem] left-1/2 transform -translate-x-1/2 bg-white px-6 py-3 rounded-lg shadow-md w-fit" 
                          style={{ borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray" }}>
                          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-blue-700 text-center">Recent Works</h2>
                        </div>
                        <p className="text-black text-lg mt-16 text-center">Showcasing some of my best projects</p>
                      </div>
                        ...
                        {["All", "PHP", "JS", "React JS", "WordPress"].map((tab, index) => (
                          <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-semibold transition w-full sm:w-auto ${
                              activeTab === tab ? "bg-blue-700 text-white shadow-md" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                            }`}
                          >
                            {tab}
                          </button>
                      ...
                      <div id="projectsGrid" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8 max-w-5xl mx-auto">
                        {projects
                          .filter((project) => activeTab === "All" || project.category === activeTab) // Filter by category first
                            ...
                            >
                              ...
                              {hoveredProject === project && (
                                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-75 rounded-lg">
                                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-white text-lg font-bold hover:underline">
                                    View Project
                                  </a>
                                </div>
                              )}
             ...
             {/* Testimonials Section */}
              <section className="testimonials-section bg-gradient-to-r from-blue-200/80 to-purple-200/80 relative py-16 px-6 md:px-16 lg:px-32 shadow-lg rounded-lg mt-16">
                  <div className="max-w-6xl mx-auto text-center px-4">
                    {/* Section Title */}
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6 bg-white px-6 py-3 rounded-lg shadow-md w-fit"
                      style={{ borderTopLeftRadius: "2rem", borderTopRightRadius: "2rem", backgroundColor: "darkgray" }}>
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-center mt-8 space-y-6 md:space-y-0 md:space-x-6">
                    {testimonials.map((testimonial, index) => (
                      ...
                      className="bg-gray-100 p-6 rounded-lg shadow-md text-center w-full md:w-1/3">
                        ...
                        <h4 className="text-lg font-semibold text-blue-700 mt-2">{testimonial.name}</h4>
                      </div>
                    ))}
                  </div>
              </section>
